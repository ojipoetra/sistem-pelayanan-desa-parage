 <!-- Modal -->
 <div class="modal fade" id="suratpengantarnikah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="suratpengantarnikah" aria-hidden="true">
          ...
          <div class="container d-flex justify-content-center align-items-center pendaftaran">
            <form action="/list-pengantar-nikah" method="post" class="row" id="form-validate">
                ...
                <div class="col-md-6 pt-2">
                    ...
                    <input type="text" name="nama_pemohon" class="form-control input-text" id="nama_pemohon" placeholder="masukan nama sesuai ktp" autocomplete="off">
                ...
                <div class="col-md-6 pt-2">
                    ...
                    <input type="number" name="nik_pemohon" class="form-control nik-validation" id="nik_pemohon" placeholder="masukan nik sesuai ktp" autocomplete="off">
                ...
                <div class="col-md-6 pt-2">
                    ...
                    <input type="text" name="tempatlahir_pemohon" class="form-control input-text" id="tempatlahir_pemohon" placeholder="Tempat Lahir" autocomplete="off">
                    <p class="invalid-feedback">Pastikan data yang di input benar</p>
                </div>
                <div class="col-md-6 pt-2">
                    <label for="tanggallahir_pemohon" class="form-label"><i class="bi bi-person"></i> Tanggal Lahir</label>
                    <input type="date" name="tanggallahir_pemohon" class="form-control" id="tanggallahir_pemohon" placeholder="dd/mm/yyyy" autocomplete="off">
                    <p class="invalid-feedback">Pastikan data yang di input benar</p>
                </div>
                
                <div class="col-md-6 pt-2">
                    <label for="kewarganegaraan_pemohon" class="form-label"><i class="bi bi-person"></i> Kewarganegaraan</label>
                    <input type="text" name="kewarganegaraan_pemohon" class="form-control input-text" id="kewarganegaraan_pemohon" placeholder="" autocomplete="off">
                    <p class="invalid-feedback">Pastikan data yang di input benar</p>
                </div>
                <div class="col-md-6 pt-2">
                    <label for="agama" class="form-label"><i class="bi bi-person"></i> Agama</label>
                    <input type="text" name="agama_pemohon" class="form-control input-text" id="agama" autocomplete="off">
                </div>
                <div class="col-md-6 pt-2">
                    <label for="pekerjaan_pemohon" class="form-label"><i class="bi bi-person"></i> Pekerjaan</label>
                    <input type="text" name="pekerjaan_pemohon" class="form-control input-text" id="pekerjaan_pemohon" placeholder="pekerjaan anda" autocomplete="off">
                    <p class="invalid-feedback">Pastikan data yang di input benar</p>
                </div>
               <div class="col-md-6 pt-2">
                ...
                <div class="col-md-6 pt-2">
                    ...
                    <input type="text" name="hasil_status" class="form-control input-text" id="hasil_status" value="" autocomplete="off">
                    <p class="invalid-feedback">Pastikan data yang di input benar</p>
                </div>

                <div class="col-md-6 pt-2">
                    <label for="alamat_pemohon" class="form-label"><i class="bi bi-person"></i> Alamat Lengkap</label>
                    <textarea name="alamat_pemohon" class="form-control input-text" id="alamat_pemohon" rows="3" autocomplete="off"></textarea>
                    <p class="invalid-feedback">Pastikan data yang di input benar</p>
                </div>
             ...
             <div class="col-md-6 pt-2">
                  ...
                  <input type="text" name="nama_calon" class="form-control input-text" id="nama_mempelay_laki" placeholder="masukan nama sesuai ktp" autocomplete="off" >
                  <p class="invalid-feedback">Pastikan data yang di input benar</p>
              </div>
              <div class="col-md-6 pt-2">
                  <label for="bintun" class="form-label"><i class="bi bi-person"></i> Nasab</label>
                  <input type="text" name="bintun" class="form-control input-text" id="bintun" placeholder="nama ayah" autocomplete="off">
                  <p class="invalid-feedback">Pastikan data yang di input benar</p>
              </div>
              <div class="col-md-6 pt-2">
                  <label for="nik_calon" class="form-label"><i class="bi bi-person"></i> NIK</label>
                  <input type="number" name="nik_calon" class="form-control nik-validation" id="nik_calon" placeholder="masukan nik sesuai ktp" autocomplete="off">
                  <p class="invalid-feedback pesan">Pastikan data yang di input benar</p>
              </div>
              <div class="col-md-6 pt-2">
              ...
              <div class="col-md-6 pt-2">
                  ...
                  <input type="text" name="tempatlahir_calon" class="form-control input-text" id="tempatlahir_calon" placeholder="Tempat Lahir" autocomplete="off">
                  <p class="invalid-feedback">Pastikan data yang di input benar</p>
              </div>
              <div class="col-md-6 pt-2">
                  <label for="tanggallahir_calon" class="form-label"><i class="bi bi-person"></i> Tanggal Lahir</label>
                  <input type="date" name="tanggallahir_calon" class="form-control" id="tanggallahir_calon" placeholder="dd/mm/yyyy">
                  <p class="invalid-feedback">Pastikan data yang di input benar</p>
              </div>
              
              <div class="col-md-6 pt-2">
                  <label for="kewarganegaraan_calon" class="form-label"><i class="bi bi-person"></i> Kewarganegaraan</label>
                  <input type="text" name="kewarganegaraan_calon" class="form-control input-text" id="kewarganegaraan_calon" autocomplete="off">
                  <p class="invalid-feedback">Pastikan data yang di input benar</p>
              </div>
              <div class="col-md-6 pt-2">
                  <label for="agama_calon" class="form-label"><i class="bi bi-person"></i> Agama</label>
                  <input type="text" name="agama_calon" class="form-control input-text" id="agama_calon" autocomplete="off">
              </div>
              <div class="col-md-6 pt-2">
                  <label for="pekerjaan_calon" class="form-label"><i class="bi bi-person"></i> Pekerjaan</label>
                  <input type="text" name="pekerjaan_calon" class="form-control input-text" id="pekerjaan_calon" placeholder="isi pekerjaan sesuai ktp" autocomplete="off">
                  <p class="invalid-feedback">Pastikan data yang di input benar</p>
              </div>
              <div class="col-md-6 pt-2">
            ...
            <div class="col-md-6 pt-2">
                ...
                <input type="text" name="nama_ayah" class="form-control input-text" id="nama_ayah" placeholder="nama ayah sesuai ktp" autocomplete="off">
                <p class="invalid-feedback">Pastikan data yang di input benar</p>
            </div>
            <div class="col-md-6 pt-2">
                <label for="bin" class="form-label"><i class="bi bi-person"></i> Nasab</label>
                <input type="text" name="bin" class="form-control input-text" id="bin" placeholder="nama ayah" autocomplete="off">
                <p class="invalid-feedback">Pastikan data yang di input benar</p>
            </div>
            <div class="col-md-6 pt-2">
                <label for="nik_ayah" class="form-label"><i class="bi bi-person"></i> NIK</label>
                <input type="number" name="nik_ayah" class="form-control nik-validation" id="nik_ayah" placeholder="masukan nik sesuai ktp" autocomplete="off">
                <p class="invalid-feedback pesan">Pastikan data yang di input benar</p>
            </div>
            <div class="col-md-6 pt-2">
                <label for="tempatlahir_ayah" class="form-label"><i class="bi bi-person"></i> Tempat Lahir</label>
                <input type="text" name="tempatlahir_ayah" class="form-control input-text" id="tempatlahir_ayah" placeholder="tempat lahir ayah">
                <p class="invalid-feedback">Pastikan data yang di input benar</p>
            </div>
            
            <div class="col-md-6 pt-2">
                <label for="tanggallahir_ayah" class="form-label"><i class="bi bi-person"></i> Tanggal Lahir</label>
                <input type="date" name="tanggallahir_ayah" class="form-control" id="tanggallahir_ayah" placeholder="dd/mm/yyyy" autocomplete="off">
                <p class="invalid-feedback">Pastikan data yang di input benar</p>
            </div>
            <div class="col-md-6 pt-2">
                <label for="kewarganegaraan_ayah" class="form-label"><i class="bi bi-person"></i> kewarganegaraan</label>
                <input type="text" name="kewarganegaraan_ayah" class="form-control input-text" id="kewarganegaraan_ayah" autocomplete="off">
            </div>
            <div class="col-md-6 pt-2">
                <label for="agama_ayah" class="form-label"><i class="bi bi-person"></i> Agama</label>
                <input type="text" name="agama_ayah" class="form-control input-text" id="agama_ayah" autocomplete="off">
                <p class="invalid-feedback">Pastikan data yang di input benar</p>
            </div>
            
            <div class="col-md-6 pt-2">
                <label for="pekerjaan_ayah" class="form-label"><i class="bi bi-person"></i> Pekerjaan</label>
                <input type="text" name="pekerjaan_ayah" class="form-control input-text" id="pekerjaan_ayah" placeholder="isi pekerjaan sesuai ktp" autocomplete="off">
                <p class="invalid-feedback">Pastikan data yang di input benar</p>
            </div>

            <div class="col-md-6 pt-2">
                <label for="alamat_ayah" class="form-label"><i class="bi bi-person"></i> Alamat Lengkap</label>
                <textarea name="alamat_ayah" class="form-control input-text" id="alamat_ayah" rows="3" autocomplete="off"></textarea>
                <p class="invalid-feedback">Pastikan data yang di input benar</p>
            </div>
            ...
            <div class="col-md-6 pt-2">
                ...
                <input type="text" name="nama_ibu" class="form-control input-text" id="nama_ibu" placeholder="masukan nama sesuai ktp" autocomplete="off">
                <p class="invalid-feedback">Pastikan data yang di input benar</p>
            </div>
            <div class="col-md-6 pt-2">
                <label for="binti" class="form-label"><i class="bi bi-person"></i> Nasab</label>
                <input type="text" name="binti" class="form-control input-text" id="binti" placeholder="nama ayah " autocomplete="off">
                <p class="invalid-feedback">Pastikan data yang di input benar</p>
            </div>
            <div class="col-md-6 pt-2">
                <label for="nik_ibu" class="form-label"><i class="bi bi-person"></i> NIK</label>
                <input type="number" name="nik_ibu" class="form-control nik-validation" id="nik_ibu" placeholder="masukan nik sesuai ktp" autocomplete="off">
                <p class="invalid-feedback pesan">Pastikan data yang di input benar</p>
            </div>
            <div class="col-md-6 pt-2">
                <label for="tempatlahir_ibu" class="form-label"><i class="bi bi-person"></i> Tempat Lahir</label>
                <input type="text" name="tempatlahir_ibu" class="form-control input-text" id="tempatlahir_ibu" placeholder="tempat lahir ibu" autocomplete="off">
                <p class="invalid-feedback">Pastikan data yang di input benar</p>
            </div>
            <div class="col-md-6 pt-2">
                <label for="tanggallahir_ibu" class="form-label"><i class="bi bi-person"></i> Tanggal Lahir</label>
                <input type="date" name="tanggallahir_ibu" class="form-control" id="tanggallahir_ibu" placeholder="dd/mm/yyyy">
                <p class="invalid-feedback">Pastikan data yang di input benar</p>
            </div>
            
            <div class="col-md-6 pt-2">
                <label for="kewarganegaraan_ibu" class="form-label"><i class="bi bi-person"></i> Kewarganegaraan</label>
                <input type="text" name="kewarganegaraan_ibu" class="form-control input-text" id="kewarganegaraan_ibu" autocomplete="off">
                <p class="invalid-feedback">Pastikan data yang di input benar</p>
            </div>
            <div class="col-md-6 pt-2">
                <label for="agama_ibu" class="form-label"><i class="bi bi-person"></i> Agama</label>
                <input type="text" name="agama_ibu" class="form-control input-text" id="agama_ibu" autocomplete="off">
            </div>
            <div class="col-md-6 pt-2">
                <label for="pekerjaan_ibu" class="form-label"><i class="bi bi-person"></i> Pekerjaan</label>
                <input type="text" name="pekerjaan_ibu" class="form-control input-text" id="pekerjaan_ibu" placeholder="isi pekerjaan sesuai ktp" autocomplete="off">
                <p class="invalid-feedback">Pastikan data yang di input benar</p>
            </div>
            <div class="col-md-6 pt-2">
                <label for="alamat_ibu" class="form-label"><i class="bi bi-person"></i> Alamat Lengkap</label>
                <textarea name="alamat_ibu" class="form-control input-text" id="alamat_ibu" rows="3" autocomplete="off"></textarea>
                <p class="invalid-feedback">Pastikan data yang di input benar</p>
            </div>
                <div class="mt-2">
